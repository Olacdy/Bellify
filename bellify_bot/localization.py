...
localization = {
    'en': {
        ...
        [
            ...
            ['The new channel under the name',
                ' has been added.\nThe last video is', ' was added.\nChannel is live now!', ' was added.\nChannel is not currently live.', 'Playing'],
    ...
    'ua': {
        ...
        [
            ...
            ['Збільшити максимальну кількість', 'каналів'],
            ['Перехід на Преміум',
                f'Повідомляє, коли YouTube або Twitch канал починає трансляцію. Збільшує максимальну кількість YouTube каналів (+{settings.INCREASE_CHANNELS_PREMIUM["YouTube"]}). Додає максимальну кількість Twitch каналів (+{settings.INCREASE_CHANNELS_PREMIUM["Twitch"]})', 'Перейти'],
