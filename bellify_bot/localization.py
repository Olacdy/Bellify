...
localization = {
    'en': {
        ...
        'manage':
        [
            ['⚙️ Manage Channels ⚙️', '⭐ Premium',
                '★ Basic account', 'Remaining', 'quota:'],
        ...
        [
            ...
            'Here You can review Your channels.\n\nIf the channel has 🔔 state You will get an unmuted notification, which means a message with sound, but if the channel has 🔕 state You will not get the messages regarding this channel.\n\nTry to mute the channel and You\'ll see that icon will change its appearance (click on bell icon).',
    ...
    'ru': {
        ...
        'manage':
        [
            ['⚙️ Управление Каналами ⚙️', '⭐ Премиум',
                '★ Базовый аккаунт', 'Остаток', 'квоты:'],
        ...
        [
            ...
            'Здесь Вы можете просмотреть добавленные Вами каналы.\n\nЕсли канал имеет свойство 🔔, то Вы будете получать сообщения в обычном режиме, в противном случае, если канал имеет свойство 🔕, Вы не будете получать сообщения касательно этого канала.\n\nПопробуйте изменить текущее свойство нажатием на иконку колокольчика.',
    ...
    'ua': {
        ...
        'manage':
        [
            ['⚙️ Керування каналами ⚙️', '⭐ Преміум',
                '★ Базовий акаунт', 'Залишок', 'квоти:'],
        ...
        [
            ...
            'Тут Ви можете продивитись додані Вами канали.\n\nЯкщо канал має властивість 🔔, то Ви будете отримувати повідомлення у звичайному режимі, в іншому випадку, якщо канал має властивість 🔕, Ви не будете отримувати повідомлення стосовно цього каналу.\n\nСпробуйте змінити поточну властивість натисканням на дзвіночок.',
