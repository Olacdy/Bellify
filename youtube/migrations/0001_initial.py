    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_upcoming', models.BooleanField(blank=True, null=True)),
                ('saved_livestream_title', models.CharField(blank=True, max_length=256, null=True)),
                ('saved_livestream_url', models.URLField(blank=True, null=True)),
                ('saved_livestream_published', models.DateTimeField(blank=True, default=datetime.datetime(1, 1, 1, 0, 0, tzinfo=utc), null=True)),
