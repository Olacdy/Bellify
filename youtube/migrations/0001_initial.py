    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_published', models.DateTimeField(blank=True, default=datetime.date(1, 1, 1), null=True)),
                ...
                ('saved_livestream_published', models.DateTimeField(blank=True, default=datetime.date(1, 1, 1), null=True)),
